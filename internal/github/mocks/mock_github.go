...
// Source: ai-intern-agent/internal/github (interfaces: Client)
//
// Generated by this command:
//
//	mockgen -destination=internal/github/mocks/mock_github.go -package=mocks ai-intern-agent/internal/github Client
//
